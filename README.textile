...
Using the {Cinch Ruby IRC plugin framework}[link:https://github.com/injekt/cinch], an IRC bot for the #jruby channel on the Freenode network was created.

It is used to respond to:

* Jira ticket information requests.
* Notify the channel about newly create Jira tickets.
...
Before starting this, make sure you have the feed_fetcher.rb running in crontab every minute:

    *       *       *       *       *       ruby jruby-bot/cron/feed_fetcher.rb > /dev/null
